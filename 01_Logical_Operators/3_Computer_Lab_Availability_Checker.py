...
print("\nAvailability status:")
print("Available during school hours:", open_for_regular_use and during_school_hours)
print("Available after school:", open_for_after_school)
print("Available on weekend:", open_for_weekend)
print("\nFinal result - Lab is available:", lab_is_available)
